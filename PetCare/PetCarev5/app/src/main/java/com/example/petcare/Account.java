                ...
                builder.setTitle("編輯")
                        ...
                        .setNegativeButton("修改", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //傳值到下一頁
                                intent.putExtra("title",title[0].toString());//日期
                                intent.putExtra("content",title[1].toString());//種類
                                intent.putExtra("other",title[2].toString());//備註
                                intent.putExtra("money",money.toString());//金額
                                startActivity(intent);
                            }
                        });
